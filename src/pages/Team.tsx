...
const Team = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* Stats Section */}
      <section className="stats-section relative py-12 px-6">
      ...
      {/* Leadership Section */}
      <section className="leadership-section relative py-20 px-6">
      ...
      {/* Engineering Section */}
      <section className="engineering-section relative py-20 px-6">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-4">
      ...
      {/* QA Section */}
      <section className="qa-section relative py-20 px-6">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-4">
      ...
      {/* Operations Section */}
      <section className="operations-section relative py-20 px-6">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-4">
